...
export class TaskListTemplatesComponent {
  ...
  // addDateAndCreateTaskList(taskListId: string) {// 1
  //   // Add the selected date to the selected task list
  //   const selectedTaskList = this.taskListForms.find(tl => tl._id === taskListId);
  //   if (selectedTaskList) {
  //     selectedTaskList.date = this.date;
  //   }
  //
  //   // Create a new task list with the selected task list's details and date
  //   const newTaskList = { ...selectedTaskList };
  //   newTaskList._id = null; // Clear the ID to create a new document
  //
  ...
  //   const modalElement = document.getElementById('addDateTaskListModal');
  //   if (modalElement) {
  //     modalElement.classList.remove('show'); // Remove 'show' class to hide the modal
  //     modalElement.style.display = 'none'; // Set 'display' to 'none' to hide the modal backdrop
  //   }
  // }
  ...
  //
  //   // Close the modal
  //   $('#addDateTaskListModal').modal('hide');
  // }


  // Open the modal and set the selected task list ID
 //Open the modal and set the selected task list ID
